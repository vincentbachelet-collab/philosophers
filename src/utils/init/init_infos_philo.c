...
/*   Updated: 2021/12/20 15:58:42 by vbachele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	display_error_max_meals(t_root *infos, int i, char *argv, int argc)
{
	if (i == 5)
	{
		if (argc == 6)
		{
			infos->number_of_times_each_philosopher_must_eat = ft_atol(argv);
...
int	display_error_eat_sleep(t_root *infos, int i, char *argv)
{
	if (i == 3)
	{
		infos->time_to_eat = ft_atol(argv) * 1000;
	...
	if (i == 4)
	{
		infos->time_to_sleep = ft_atol(argv) * 1000;
...
int	display_error(t_root *infos, int i, char *argv)
{
	if (i == 1)
	{
		...
		else if (infos->number_of_philosophers < 1)
		{
	...
	if (i == 2)
	{
		infos->time_to_die = ft_atol(argv) * 1;
